        ...
        <>
            <div className='justify-between p-4 h-screen bg-gradient-to-r from-fuchsia-500 to-cyan-500'>
                <div className='m-3'>
                    ...
                    <div className="flex justify-center flex-wrap gap-2 lg:grid-cols-4 xl:grid-cols-5 p-6 bg-cyan-200 border border-red-600 rounded-lg">
                        <div className="bg-white rounded-lg shadow w-14 h-14 flex justify-center items-center">
                        ...
                        <div className="xl:col-start-2 bg-white rounded-lg shadow w-14 h-14 flex justify-center items-center">
                ...
                <div className='m-3'>
                    ...
                    <div className="flex justify-center flex-wrap gap-2 lg:grid-cols-4 xl:grid-cols-5 p-6 bg-red-200 border border-cyan-600 rounded-lg">
                        <div className="bg-white rounded-lg shadow w-14 h-14 flex justify-center items-center">
